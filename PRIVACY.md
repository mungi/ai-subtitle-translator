...
- Host permissions: Udemy·YouTube 자막 조회, 선택한 번역 provider 호출, `localhost`/`127.0.0.1` Custom LLM 호출에 사용합니다. 사용자 지정 HTTPS Custom LLM domain은 모델 가져오기 또는 연결 테스트 시 사용자가 승인한 경우에만 접근합니다.
